...
While experimenting with a Kademlia\footnote{\url{https://en.wikipedia.org/wiki/Kademlia}} simulation, I started wondering: 
...
At the same time, this makes the system controllable in an interesting way: since node identifiers are vectors, one can deliberately choose an ID that lies close to a particular region of the embedding space, effectively making a node “attract” specific kinds of data.
